...
glancing into some of the rooms. Let's go to Coney Island, old sport. In
my car.''
...
``What day would suit \emph{you}?'' he corrected me quickly. ``I don't
...
thought the rain would stop about four. I think it was \emph{The
...
through a copy of Clay's \emph{Economics}, starting at the Finnish tread
that shook the kitchen floor, and peering towards the bleared windows
...
on all the neighbouring cottages if the owners would have their roofs
...
willing, even eager, to be serfs, have always been obstinate about being
peasantry.
...
leaning from the large central bay, spat meditatively into the garden.
It was time I went back. While the rain continued it had seemed like the
...
``That huge place \emph{there}?'' she cried pointing.
...
Instead of taking the shortcut along the Sound we went down to the road
...
the gardens, the sparkling odour of jonquils and the frothy odour of
hawthorn and plum blossoms and the pale gold odour of
...
a bedroom and a bath, and an Adam's study, where we sat down and drank a
...
garnished with a toilet set of pure dull gold. Daisy took the brush with
...
their folds as they fell and covered the table in many-coloured
...
``Yes\ldots{} Well, I can't talk now\ldots{} I can't talk now, old
sport\ldots{} I said a \emph{small} town\ldots{} He must know what a
small town is\ldots{} Well, he's no use to us if Detroit is his idea of
a small town\ldots''

He rang off.

``Come here \emph{quick}!'' cried Daisy at the window.
...
``That is, I'd \emph{been} asleep. Then I got up\ldots''

``Klipspringer plays the piano,'' said Gatsby, cutting him off. ``Don't
you, Ewing, old sport?''

``I don't play well. I don't---hardly play at all. I'm all out of
prac---''
