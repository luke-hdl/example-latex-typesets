...
# This script can be used to strip Sudoku Exhange puzzlebank information that isn't needed out, leaving only the part of the string that sudoku.tex needs. 
